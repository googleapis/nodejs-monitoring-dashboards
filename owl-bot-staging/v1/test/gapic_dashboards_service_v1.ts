...
describe('v1.DashboardsServiceClient', () => {
    ...
    describe('createDashboard', () => {
        it('invokes createDashboard without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateDashboardRequest', ['parent']);
    ...
    describe('getDashboard', () => {
        it('invokes getDashboard without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetDashboardRequest', ['name']);
    ...
    describe('deleteDashboard', () => {
        it('invokes deleteDashboard without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteDashboardRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('updateDashboard', () => {
        it('invokes updateDashboard without error', async () => {
            ...
            request.dashboard ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateDashboardRequest', ['dashboard', 'name']);
    ...
    describe('listDashboards', () => {
        it('invokes listDashboards without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListDashboardsRequest', ['parent']);
            request.parent = defaultValue1;
